...
from app.models.models import Team, Tournament
...
class TestTournamentService:
    ...
    def test_get_tournament_by_id_success(
    ...
    def test_get_tournament_teams_success(
        self, service, mock_get_supabase, mock_team_data
    ):
    ...
    def test_get_tournament_with_teams_success(
        self, service, mock_get_supabase, mock_tournament_data, mock_team_data
    ):
    ...
    def test_get_tournament_with_teams_no_teams(
        self, service, mock_get_supabase, mock_tournament_data
    ):
    ...
    def test_validate_tournament_data_insufficient_teams(self, service):
        ...
        tournament_data = {
            "tournament": Mock(
                max_teams=8, courts_available=2, tournament_type="round_robin"
            ),
    ...
    def test_validate_tournament_data_too_many_teams(self, service):
        ...
        tournament_data = {
            "tournament": Mock(
                max_teams=2, courts_available=2, tournament_type="round_robin"
            ),
    ...
    def test_validate_tournament_data_no_courts(self, service):
        ...
        tournament_data = {
            "tournament": Mock(
                max_teams=8, courts_available=0, tournament_type="round_robin"
            ),
            "teams": [Mock(), Mock()],
        }
    ...
    def test_validate_tournament_data_no_type(self, service):
        ...
        tournament_data = {
            "tournament": Mock(max_teams=8, courts_available=2, tournament_type=None),
            "teams": [Mock(), Mock()],
        }
    ...
    def test_validate_tournament_data_exception(self, service):
        ...
        tournament_data = {"tournament": Mock(), "teams": Mock()}
