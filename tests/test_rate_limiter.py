...
class TestRateLimiter:
    ...
    def test_rate_limit_on_generate_planning(self):
        ...
        assert hasattr(generate_planning, '__wrapped__') or hasattr(generate_planning, 'limiter')
    ...
    def test_rate_limit_on_get_status(self):
        ...
        # Le décorateur devrait être appliqué
        assert hasattr(get_planning_status, '__wrapped__') or hasattr(get_planning_status, 'limiter')
    ...
    def test_rate_limit_on_regenerate_planning(self):
        ...
        # Le décorateur devrait être appliqué
        assert hasattr(regenerate_planning, '__wrapped__') or hasattr(regenerate_planning, 'limiter')
    ...
    def test_rate_limit_on_get_planning_by_id(self):
        ...
        # Le décorateur devrait être appliqué
        assert hasattr(get_planning_by_id, '__wrapped__') or hasattr(get_planning_by_id, 'limiter')
    ...
    def test_rate_limit_on_get_planning_by_tournament_id(self):
        ...
        # Le décorateur devrait être appliqué
        assert hasattr(get_planning_by_tournament_id, '__wrapped__') or hasattr(get_planning_by_tournament_id, 'limiter')
