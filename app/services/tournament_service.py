...
class TournamentService:
    ...
    def __init__(self, supabase_client=None):
        ...
        """
        self.supabase = (
            supabase_client if supabase_client is not None else getSupabase()
        )
    ...
    def getTournamentById(self, tournamentId: str) -> Optional[Tournament]:
        ...
        try:
            ...
            result = (
                self.supabase.table("tournament")
                .select("*")
                .eq("id", tournamentId)
                .single()
                .execute()
    ...
    def _validateTournamentData(self, tournamentData: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            print(
                f"🔍 Validation: {len(teams)} équipes, {tournament.courts_available} terrains"
            )
